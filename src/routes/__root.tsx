...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "ResearchFlow AI — Smart AI Research & Planning" },
      { name: "twitter:title", content: "ResearchFlow AI — Smart AI Research & Planning" },
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/GWbYa4nBLGSzloutWLwRMpDSkX52/social-images/social-1782172778670-snergy_mind_AI.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/GWbYa4nBLGSzloutWLwRMpDSkX52/social-images/social-1782172778670-snergy_mind_AI.webp" },
